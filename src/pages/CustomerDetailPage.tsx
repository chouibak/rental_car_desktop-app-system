...
import { IconChevronRight, IconEdit, IconPlus, IconTrash } from '../components/icons'
...
export default function CustomerDetailPage() {
  ...
  return (
    <div>
      ...
      >
        <Link className="btn secondary sm" to="/customers">
          {t.back}
        </Link>
        <Link className="btn sm" to={`/customers/${customer.id}/edit`}>
          <IconEdit size={15} />
          {t.edit}
        </Link>
      ...
      <div className="panel">
        <div className="panel-header">
          ...
          <Link className="btn sm" to={`/reservations/new?customer=${customer.id}`}>
            <IconPlus size={15} />
            {t.newReservation}
          </Link>
        </div>
            ...
            <tbody>
              {loadingReservations ? (
                ...
                reservations.map((reservation) => {
                  ...
                  const paymentStatus = reservationPaymentStatus(paid, reservation.total_amount)
